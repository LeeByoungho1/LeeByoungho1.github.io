...
$(window).on("scroll", function () {
  ...
  if (scroll > 6000) {
    $(".focustxt div").eq(0).css({"border-width":"0"})
  } else {
    $(".focustxt div").eq(0).css({"border-width":"2px"})
  }
})
...
$(window).on("scroll", function () {
  ...
  if (scroll > 9000) {
    $(".focustxt div").eq(1).css({"border-width":"0"})
  } else {
    $(".focustxt div").eq(1).css({"border-width":"2px"})
  }
})
...
$(window).on("scroll", function () {
  ...
  if (scroll > 12000) {
    $(".focustxt div").eq(2).css({"border-width":"0"})
  } else {
    $(".focustxt div").eq(2).css({"border-width":"2px"})
  }
})
...
$(window).on("scroll", function () {
  ...
  } else if (scroll < 38000) {
    $("#a1").css({"pointer-events": "auto"})
  } else {
    $("#a1").css({"pointer-events": "none"})
  }
  ...
  } else if (scroll < 45000) {
    $("#a2").css({"pointer-events": "auto"})
  } else {
    $("#a2").css({"pointer-events": "none"})
  }
})
